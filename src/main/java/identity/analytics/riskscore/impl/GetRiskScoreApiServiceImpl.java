...
public class GetRiskScoreApiServiceImpl extends GetRiskScoreApiService {
    ...
    public GetRiskScoreApiServiceImpl() {
        ...
        try {
            ...
            log.error("Exception occurred when reading CEP config at repository/conf/cep-config.xml. Please check the" +
                    " configurations");
            throw new RuntimeException("Exception occurred when reading CEP config at repository/conf/cep-config.xml. Please check the" +
                    " configurations", e);
        }
    ...
    /**
     * auth request is forwarded to publisher to publish to CEP. Then upon calling getResults() request thread will block on a
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    log.error("Forgotten Product Service API deployment held back due to unavailability of event " +
                ...
                log.info("Forgotten Product Service API Successfully subscribed to event streams");
                break;
            }
